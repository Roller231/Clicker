...
public class GirlBuyScript : MonoBehaviour
{
    ...
    [SerializeField] public  GameObject fone;
    ...
    {
        foreach(GirlBuyScript girlScript in gameManager.girlBuyScripts)
        {
            girlScript.fone.SetActive(false);
        }
        fone.SetActive(true);
